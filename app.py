...
def run_generated_code(file_path):
    ...
    try:
        ...
        if result.returncode == 0:
            st.success("Generated code totally worked my dude.")
            # Display the output of the generated code
            st.code(result.stdout, language="python")
        else:
            st.error("Generated code totally failed because of this error:")
